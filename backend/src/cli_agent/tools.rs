...
impl Tool {
    fn shell_definition() -> ToolDefinition {
        ...
        properties.insert("command".to_string(), ParameterProperty {
            prop_type: "string".to_string(),
            description: Some("The shell command to execute".to_string()),
            default: None,
        });
        
        properties.insert("workdir".to_string(), ParameterProperty {
            prop_type: "string".to_string(),
            description: Some("Working directory for command execution. Defaults to current directory.".to_string()),
            default: None,
        });
        
        properties.insert("timeout_ms".to_string(), ParameterProperty {
            prop_type: "number".to_string(),
            description: Some("Timeout in milliseconds. Defaults to 30000 (30 seconds).".to_string()),
    ...
    fn read_file_definition() -> ToolDefinition {
        ...
        properties.insert("path".to_string(), ParameterProperty {
            prop_type: "string".to_string(),
            description: Some("Path to the file to read (absolute or relative to working directory)".to_string()),
            default: None,
        });
        
        properties.insert("start_line".to_string(), ParameterProperty {
            prop_type: "number".to_string(),
            description: Some("Starting line number (1-indexed). Defaults to 1.".to_string()),
            default: Some(serde_json::json!(1)),
        });
        
        properties.insert("end_line".to_string(), ParameterProperty {
            prop_type: "number".to_string(),
            description: Some("Ending line number (inclusive). Defaults to end of file.".to_string()),
            default: None,
        });

        ToolDefinition {
            name: "read_file".to_string(),
            description: "Read the contents of a file. Can read entire file or specific line ranges.".to_string(),
            parameters: ToolParameters {
                param_type: "object".to_string(),
                properties,
    ...
    fn write_file_definition() -> ToolDefinition {
        ...
        properties.insert("path".to_string(), ParameterProperty {
            prop_type: "string".to_string(),
            description: Some("Path to the file to write (absolute or relative to working directory)".to_string()),
            default: None,
        });
        
        properties.insert("content".to_string(), ParameterProperty {
            prop_type: "string".to_string(),
            description: Some("Content to write to the file".to_string()),
            default: None,
        });
        
        properties.insert("mode".to_string(), ParameterProperty {
            prop_type: "string".to_string(),
        ...
        ToolDefinition {
            ...
            description: "Write content to a file. Can overwrite or append to existing files.".to_string(),
            parameters: ToolParameters {
                param_type: "object".to_string(),
                properties,
    ...
    fn list_directory_definition() -> ToolDefinition {
        ...
        properties.insert("path".to_string(), ParameterProperty {
            prop_type: "string".to_string(),
            description: Some("Path to the directory to list (absolute or relative)".to_string()),
            default: None,
        });
        
        properties.insert("depth".to_string(), ParameterProperty {
            prop_type: "number".to_string(),
            description: Some("Maximum depth to traverse. Defaults to 1 (immediate children only).".to_string()),
            default: Some(serde_json::json!(1)),
        });
        
        properties.insert("include_hidden".to_string(), ParameterProperty {
            prop_type: "boolean".to_string(),
            description: Some("Include hidden files (starting with '.'). Defaults to false.".to_string()),
    ...
    fn search_files_definition() -> ToolDefinition {
        ...
        properties.insert("pattern".to_string(), ParameterProperty {
            prop_type: "string".to_string(),
            description: Some("Search pattern (glob pattern for filenames or regex for content)".to_string()),
            default: None,
        });
        
        properties.insert("path".to_string(), ParameterProperty {
            prop_type: "string".to_string(),
            description: Some("Directory to search in. Defaults to current directory.".to_string()),
        ...
        properties.insert("max_results".to_string(), ParameterProperty {
            prop_type: "number".to_string(),
        ...
        ToolDefinition {
            ...
            description: "Search for files by name pattern or content. Returns matching file paths.".to_string(),
            parameters: ToolParameters {
                param_type: "object".to_string(),
                properties,
