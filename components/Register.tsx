      ...
      <div className="flex-1 px-6 py-4 overflow-y-auto">
        <div className="max-w-sm mx-auto space-y-5">
          ...
          <div className="space-y-3">
            <SSOButton provider="google" onClick={() => handleSSORegister('google')} isLoading={ssoLoading === 'google'} />
            <SSOButton provider="microsoft" onClick={() => handleSSORegister('microsoft')} isLoading={ssoLoading === 'microsoft'} />
            <SSOButton provider="apple" onClick={() => handleSSORegister('apple')} isLoading={ssoLoading === 'apple'} />
          </div>
