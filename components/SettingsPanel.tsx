...
const SettingsPanel: React.FC<SettingsPanelProps> = ({ onClose, onOpenTraceability }) => {
  ...
  const renderHelpCenterPanel = () => (
    <div className="space-y-6">
      ...
      {/* Change Email */}
      {/* <div className="space-y-3">
        <label className="text-sm font-bold font-jakarta text-text-primary">Email Address</label>
        ...
        <div className="flex gap-3">
          <input
            ...
            className="flex-1 p-3 rounded-xl glass-subtle text-sm font-medium font-jakarta text-text-primary placeholder:text-text-secondary focus:outline-none focus:ring-2 focus:ring-accent"
          />
          <button
            onClick={handleUpdateEmail}
            disabled={isUpdatingEmail || !newEmail}
            className="px-4 py-3 rounded-xl font-bold text-sm font-jakarta transition-all text-white hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed bg-accent"
          >
      ...
      {/* Change Password */}
      <div className="space-y-3">
        <label className="text-sm font-bold font-jakarta text-text-primary">Password</label>
        <p className="text-xs text-text-secondary font-jakarta">
        ...
        <div className="space-y-3">
          <input
            ...
            className="w-full p-3 rounded-xl glass-subtle text-sm font-medium font-jakarta text-text-primary placeholder:text-text-secondary focus:outline-none focus:ring-2 focus:ring-accent"
          />
          <input
            type="password"
          ...
          <button
            ...
            className="w-full p-3 rounded-xl font-bold text-sm font-jakarta transition-all text-white hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed bg-accent"
          >
      ...
      <div className="space-y-3">
        <label className="text-sm font-bold font-jakarta text-text-primary">Data Export</label>
        <p className="text-xs text-text-secondary font-jakarta">
        ...
        <div className="p-4 rounded-xl glass-subtle">
          <div className="flex items-center justify-between mb-3">
            <div>
              <p className="text-sm font-bold font-jakarta text-text-primary">Personal Data Archive</p>
              <p className="text-xs text-text-secondary font-jakarta">Includes all conversations and settings</p>
            </div>
            <button
              onClick={handleDownloadData}
              disabled={isDownloading}
              className="px-4 py-2 rounded-xl font-bold text-sm font-jakarta transition-all text-white hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed bg-accent"
            >
              {isDownloading ? 'Preparing...' : 'Download'}
            </button>
          </div>
          <div className="text-xs text-text-secondary font-jakarta">
      ...
      <div className="p-4 rounded-xl glass-subtle">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-bold font-jakarta text-text-primary mb-1">Privacy Notice</p>
            <p className="text-xs text-[#5a7a94] font-jakarta">
