...
export const ACTION_PROMPTS = {
  ...
  Space: [
    ...
    "Curious about storage usage?",
    "Which folder is the culprit?",
    "Where's all the space going?",
    "What's taking up room?",
    "Analyze which directory?",
    "What's hogging storage?",
    ...
    "What's using space?",
    "Where to look for bloat?",
    "Which directory is heavy?",
    "What's consuming storage?",
    "Analyze storage how?",
    "Where's the disk usage?",
    "What folder to check?",
    "Which path needs analysis?",
    "What's the storage hog?",
    "Where to find large files?",
    "Which area to scan?",
    "What's taking space?",
    "Analyze which path?",
    "Where's storage going?",
    "What directory to check?",
    "Which folder is big?",
    "What's using disk?",
    "Where to look?",
    "Which drive to analyze?",
    "What's the space issue?",
    "Where's the problem?",
    "What folder is heavy?",
    "Which path to scan?",
    "What's filling storage?",
    "Where to check?",
    "Which directory is full?",
    "What's the culprit?",
    "Analyze storage where?",
    "What's hogging disk?",
    "Where's the usage?",
    "Which folder to scan?",
    "What path to check?",
    "Where's disk space going?",
    "What's consuming room?",
    "Which area is heavy?",
    "What to analyze?",
  ...
  Cleanup: [
    ...
    "Ready to free some space?",
    "Which files can go?",
    "What's safe to remove?",
    "Time to declutter?",
    "What needs cleaning?",
    "Which junk to remove?",
    "What can be deleted?",
    "Ready to tidy up?",
    "What's removable?",
...
export const QUICK_ACTIONS = [
  { id: 'Files', color: '#D1DBCB', activeColor: '#5a7a4a', placeholder: 'Which file are you looking for?' },
  { id: 'Agents', color: '#EAD8DE', activeColor: '#9a5a6a', placeholder: 'Ask an agent for help...' },
  { id: 'Space', color: '#F9F1D2', activeColor: '#8a7a3a', placeholder: 'Ask about disk usage...' },
  { id: 'Cleanup', color: '#E1D5E3', activeColor: '#7a5a8a', placeholder: 'Identify removable files...' },
] as const;
