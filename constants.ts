...
export const QUICK_ACTIONS = [
  { id: 'Files', color: COLORS.almostAqua, placeholder: 'Which file are you looking for?' },
  { id: 'Messages', color: COLORS.raindropsOnRoses, placeholder: 'Search in conversations for...' },
  { id: 'Space', color: COLORS.lemonIcing, placeholder: 'Ask about disk usage...' },
  { id: 'Cleanup', color: COLORS.orchidTint, placeholder: 'Identify removable files...' },
] as const;
